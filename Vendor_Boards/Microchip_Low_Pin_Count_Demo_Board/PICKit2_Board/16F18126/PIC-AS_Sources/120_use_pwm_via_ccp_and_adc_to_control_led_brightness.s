...
;PROCESSOR   16F18126
 PAGEWIDTH   180
 RADIX       DEC
 TITLE       "d:\GreatCowBASICGits\Demonstration_Sources.git\trunk\Vendor_Boards\Microchip_Low_Pin_Count_Demo_Board\PICKit2_Board\16F18126\120_use_pwm_via_ccp_and_adc_to_control_led_brightness.s"
 SUBTITLE    "11-24-2022"
...
;ADCVal = ReadAD( ANA0 )
	...
	MOVWF	ADCVAL
;ADCVal = Scale ( ADCVal, 0 , 213, 0, 255 )
	MOVWF	L_MAP
	CLRF	L_MAP_H
	CLRF	L_FROMLOW
	CLRF	L_FROMLOW_H
...
;
;These are not used - so optimise
...
;SOURCE: 120_USE_PWM_VIA_CCP_AND_ADC_TO_CONTROL_LED_BRIGHTNESS.GCB (41)
GLOBAL	INITPPS
INITPPS:
;Module: CCP1
