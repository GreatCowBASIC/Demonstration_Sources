# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\210_i2c_glcd_sprites_using_ssd1306.S"
# 1 "<built-in>" 1
# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\210_i2c_glcd_sprites_using_ssd1306.S" 2
...
# 72 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\210_i2c_glcd_sprites_using_ssd1306.S" 2
...
;''ONLY SUPPORT I2C AND ((CRCCON0) and 0FFh), 0, b GLCD MODE - SUPPORTED FROM V1.XX ONWARDS
;''
;''THE #DEFINE 'SPRITECHOICE' DEFINES THE SPRITE TO BE MANAGED.
;''YOU CAN DEFINE YOUR OWN ((CWG1CON1) and 0FFh), 5, b THE SPRITE TABLES. EACH TABLE IS 8 PIXLES VERTICAL - COL1 TO COL8 ((CWG1CON1) and 0FFh), 5, b EACH TABLE.
;''
;''
;''************************************************************************
;''AUTHOR EVANV
...
;'FOR SSD1306_BUFFERLOCATIONCALC = 1 TO GLCD_HEIGHT * GLCD_WIDTH / 8
 MOVLW 1
 MOVWF SSD1306_BUFFERLOCATIONCALC,a
 CLRF SSD1306_BUFFERLOCATIONCALC_H,a
GLOBAL SYSFORLOOP7
SYSFORLOOP7:
;'SSD1306_BUFFERALIAS(SSD1306_BUFFERLOCATIONCALC) = 0
 LFSR 0,SSD1306_BUFFERALIAS
 MOVF SSD1306_BUFFERLOCATIONCALC,W,a
 ADDWF FSR0,F,a
 MOVF SSD1306_BUFFERLOCATIONCALC_H,W,a
 ADDWFC FSR0H,F,a
 CLRF INDF0,a
;'NEXT
;'POSITIVE VALUE STEP HANDLER IN FOR-NEXT STATEMENT :#4P 
 ...
 BRA ENDIF34
;'SET LOOPVAR TO LOOPVAR + STEPVALUE WHERE STEPVALUE IS A POSITIVE VALUE
 INCF SSD1306_BUFFERLOCATIONCALC,F,a
 BTFSC STATUS,2,a
 INCF SSD1306_BUFFERLOCATIONCALC_H,F,a
 BRA SYSFORLOOP7
;'END IF
GLOBAL ENDIF34
ENDIF34:
...
;'FOR SSD1306_BUFFERLOCATIONCALC = 0 TO GLCD_HEIGHT-1 STEP 8
 CLRF SSD1306_BUFFERLOCATIONCALC,a
 CLRF SSD1306_BUFFERLOCATIONCALC_H,a
GLOBAL SYSFORLOOP8
SYSFORLOOP8:
;'INIT SYSFORLOOPSTEP7 :#0
 ...
 MOVWF SYSFORLOOPSTEP7,b
 CLRF SYSFORLOOPSTEP7_H,b
...
;'INTEGER NEGATIVE STEP HANDLER IN FOR-NEXT STATEMENT
 ...
 BTFSS SYSFORLOOPSTEP7_H,7,b
 BRA ELSE36_1
;'SET SYSFORLOOPABSVALUE TO -STEPVALUE :#1 
 COMF SYSFORLOOPSTEP7,W,b
 MOVWF SYSFORLOOPABSVALUE8,b
 COMF SYSFORLOOPSTEP7_H,W,b
 MOVWF SYSFORLOOPABSVALUE8_H,b
 INCF SYSFORLOOPABSVALUE8,F,b
 BTFSC STATUS,2,a
 INCF SYSFORLOOPABSVALUE8_H,F,b
;'IF ( SSD1306_BUFFERLOCATIONCALC - 64-1) } [WORD]SYSFORLOOPABSVALUE8 THEN  :#1N 
 MOVLW 64
 SUBWF SSD1306_BUFFERLOCATIONCALC,W,a
 MOVWF SYSTEMP1,b
 MOVLW 0
 SUBWFB SSD1306_BUFFERLOCATIONCALC_H,W,a
 MOVWF SYSTEMP1_H,b
 MOVLW 1
 SUBWF SYSTEMP1,W,b
 MOVWF SYSTEMP2,b
...
;'SET LOOPVAR TO LOOPVAR + STEPVALUE WHERE STEPVALUE IS A NEGATIVE VALUE
 BANKSEL SYSFORLOOPSTEP7
 MOVF SYSFORLOOPSTEP7,W,b
 ADDWF SSD1306_BUFFERLOCATIONCALC,F,a
 MOVF SYSFORLOOPSTEP7_H,W,b
 ADDWFC SSD1306_BUFFERLOCATIONCALC_H,F,a
 BRA SYSFORLOOP8
;'END IF
GLOBAL ENDIF37
ENDIF37:
...
;'ROTATE SSD1306_BUFFERLOCATIONCALC LEFT
 RLCF SSD1306_BUFFERLOCATIONCALC,F,a
 RLCF SSD1306_BUFFERLOCATIONCALC_H,F,a
;'END REPEAT
 DECFSZ SYSREPEATTEMP1,F,b
 BRA SYSREPEATLOOP2
...
;'REPEAT 3
 MOVLW 3
 MOVWF SYSREPEATTEMP6,b
GLOBAL SYSREPEATLOOP6
SYSREPEATLOOP6:
;'SET C OFF
 BCF STATUS,0,a
;'ROTATE SSD1306_BUFFERLOCATIONCALC RIGHT
 RRCF SSD1306_BUFFERLOCATIONCALC_H,F,a
 RRCF SSD1306_BUFFERLOCATIONCALC,F,a
;'END REPEAT
 DECFSZ SYSREPEATTEMP6,F,b
 BRA SYSREPEATLOOP6
...
;'SSD1306_BUFFERLOCATIONCALC = GLCDX + SSD1306_BUFFERLOCATIONCALC + 1
 ...
 MOVLW 0
 ADDWFC SYSTEMP1_H,W,b
 MOVWF SSD1306_BUFFERLOCATIONCALC_H,a
...
;'ROTATE RANDOMTEMP LEFT SIMPLE
 RLCF RANDOMTEMP_H,W,a
 RLCF RANDOMTEMP,F,a
 RLCF RANDOMTEMP_H,F,a
...
;'RANDOMSEED = RANDOMTEMP XOR (NOT (RANDOMSEED AND 1) + 1 AND 0XB400)
 ...
 CLRF SYSTEMP1,b
 MOVLW 180
 ANDWF SYSTEMP2_H,W,b
 MOVWF SYSTEMP1_H,b
 MOVF RANDOMTEMP,W,a
 XORWF SYSTEMP1,W,b
 MOVWF RANDOMSEED,a
 MOVF RANDOMTEMP_H,W,a
 XORWF SYSTEMP1_H,W,b
 MOVWF RANDOMSEED_H,a
;'EXPANDED BELOW CALCULATION TO REDUCE COMPLEXITY OF CALC
...
;'RANDOM = RANDOM XOR RANDOMSEED_H
 MOVF RANDOM,W,a
 XORWF RANDOMSEED_H,W,a
 MOVWF RANDOM,a
;'END REPEAT
 DECFSZ SYSREPEATTEMP5,F,b
 BRA SYSREPEATLOOP5
...
SPRITE1:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE1
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE2:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE2
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE3:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE3
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE4:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE4
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE5:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE5
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE6:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE6
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE7:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE7
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SPRITE8:
 ...
 ADDLW 1
 MOVWF TBLPTRH,a
 MOVLW low highword TABLESPRITE8
 BTFSC STATUS,0,a
 ADDLW 1
 MOVWF TBLPTRU,a
 TBLRD*
...
SYSDIV8START:
 ...
 BCF STATUS,0,a
;'RLF SYSBYTETEMPA, F
 RLCF SYSBYTETEMPA, F,a
;'RLF SYSBYTETEMPX, F
 RLCF SYSBYTETEMPX, F,a
;'MOVF SYSBYTETEMPB, W
 MOVF SYSBYTETEMPB, W,a
;'SUBWF SYSBYTETEMPX, F
 SUBWF SYSBYTETEMPX, F,a
;'BSF SYSBYTETEMPA, 0
 BSF SYSBYTETEMPA, 0,a
 ;BTFSC STATUS,0
 BTFSC STATUS,0,a
;'GOTO DIV8NOTNEG
 BRA DIV8NOTNEG
;'BCF SYSBYTETEMPA, 0
 BCF SYSBYTETEMPA, 0,a
;'MOVF SYSBYTETEMPB, W
 MOVF SYSBYTETEMPB, W,a
;'ADDWF SYSBYTETEMPX, F
 ADDWF SYSBYTETEMPX, F,a
GLOBAL DIV8NOTNEG
DIV8NOTNEG:
;'DECFSZ SYSDIVLOOP, F
