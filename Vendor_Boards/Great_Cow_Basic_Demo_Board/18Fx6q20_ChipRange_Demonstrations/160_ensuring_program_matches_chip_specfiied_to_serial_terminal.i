# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\160_ensuring_program_matches_chip_specfiied_to_serial_terminal.S"
# 1 "<built-in>" 1
# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\160_ensuring_program_matches_chip_specfiied_to_serial_terminal.S" 2
...
;'PROCESSOR   18F16Q20
 PAGEWIDTH 180
 RADIX DEC
 TITLE "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Great_Cow_Basic_Demo_Board\18Fx6q20_ChipRange_Demonstrations\160_ensuring_program_matches_chip_specfiied_to_serial_terminal.s"
 SUBTITLE "02-12-2024"
...
# 72 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\160_ensuring_program_matches_chip_specfiied_to_serial_terminal.S" 2
...
;'HSERPRINT  CHIPNAMESTR + " GCBASIC DEMO"
 ...
 MOVWF TBLPTRH,a
 MOVLW low highword STRINGTABLE97
 MOVWF TBLPTRU,a
...
;'ASC = SYSINSTRINGA( SYSCHAR )
 MOVF SYSCHAR,W,a
 ADDWF SYSSYSINSTRINGAHANDLER,W,a
 MOVWF FSR0,a
 MOVLW 0
 ADDWFC SYSSYSINSTRINGAHANDLER_H,W,a
 MOVWF FSR0H,a
 MOVFF INDF0,ASC
 RETURN
...
;'SOURCE: 160_ENSURING_PROGRAM_MATCHES_CHIP_SPECFIIED_TO_SERIAL_TERMINAL.GCB (27)
GLOBAL INITPPS
INITPPS:
...
;'LTRIM = ""
 ...
 MOVWF TBLPTRH,a
 MOVLW low highword STRINGTABLE50
 MOVWF TBLPTRU,a
 RCALL SYSREADSTRING
...
;'IF ASC(MID (SYSINSTRING2, SYSTEMPLT , 1)) <> 32 THEN
 ...
 RCALL FN_MID
 MOVLW LOW MID
 MOVWF SYSSYSINSTRINGAHANDLER,a
 MOVLW HIGH MID
 MOVWF SYSSYSINSTRINGAHANDLER_H,a
 MOVLW 1
 MOVWF SYSCHAR,a
 RCALL FN_ASC
 MOVLW 32
...
;'INIT SYSFORLOOPSTEP4 :#0
 SETF SYSFORLOOPSTEP4,a
 SETF SYSFORLOOPSTEP4_H,a
;'WAS ASC(MID (SYSINSTRING3, SYSTEMPRT , 1))
;'IF SYSINSTRING3(SYSTEMPRT) <> 32 THEN
 MOVF SYSTEMPRT,W,a
 ADDWF SYSSYSINSTRING3HANDLER,W,a
 MOVWF FSR0,a
 MOVLW 0
 ADDWFC SYSSYSINSTRING3HANDLER_H,W,a
 MOVWF FSR0H,a
 MOVLW 32
 SUBWF INDF0,W,a
 BTFSC STATUS,2,a
...
;'INTEGER NEGATIVE STEP HANDLER IN FOR-NEXT STATEMENT
 BTFSS SYSFORLOOPSTEP4_H,7,a
 BRA ELSE21_1
;'IF ( SYSTEMPRT - 1) } -SYSFORLOOPSTEP4 THEN :#3N
 DECF SYSTEMPRT,W,a
 MOVWF SYSTEMP1,a
 COMF SYSFORLOOPSTEP4,W,a
 MOVWF SYSTEMP2,a
 COMF SYSFORLOOPSTEP4_H,W,a
 MOVWF SYSTEMP2_H,a
 INCF SYSTEMP2,F,a
 BTFSC STATUS,2,a
 INCF SYSTEMP2_H,F,a
...
GLOBAL STRINGTABLE50
STRINGTABLE50:
 DB 0

 ALIGN 2;X3

GLOBAL STRINGTABLE97
STRINGTABLE97:
 DB 8,49,56,70,49,54,81,50,48
...
;'TRIM = RTRIM(LTRIM(SYSINSTRING))
 ...
 RCALL FN_LTRIM
 MOVLW LOW LTRIM
 MOVWF SYSSYSINSTRING3HANDLER,a
 MOVLW HIGH LTRIM
 MOVWF SYSSYSINSTRING3HANDLER_H,a
 RCALL FN_RTRIM
 LFSR 1,TRIM
 LFSR 0,RTRIM
 BRA SYSCOPYSTRING
