# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\150_showing_tableeeprom_data_to_serial_terminal.S"
# 1 "<built-in>" 1
# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\150_showing_tableeeprom_data_to_serial_terminal.S" 2
;'Program compiled by GCBASIC (2024.2.12 (Windows 64 bit) : Build 1334) for Microchip PIC-AS using FreeBASIC 1.07.1/2024-02-12 CRC247
...
;'PROCESSOR   18F16Q20
 PAGEWIDTH 180
 RADIX DEC
 TITLE "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Great_Cow_Basic_Demo_Board\18Fx6q20_ChipRange_Demonstrations\150_showing_tableeeprom_data_to_serial_terminal.s"
 SUBTITLE "02-12-2024"
...
;'Inferred CONFIG
 ...
 CONFIG VDDIO3MD=LOW_VOLTAGE_RANGE ;C1 Reverselookup VDDIO3MD=LOW_VOLTAGE_RANGE
...
# 72 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Great_Cow_Basic_Demo_Board\\18Fx6q20_ChipRange_Demonstrations\\150_showing_tableeeprom_data_to_serial_terminal.S" 2
...
;'OVERLOADED SIGNATURE: STRING:BYTE:, SOURCE: USART.H (2455)
GLOBAL HSERPRINT315
HSERPRINT315:
...
;'SOURCE: 150_SHOWING_TABLEEEPROM_DATA_TO_SERIAL_TERMINAL.GCB (26)
GLOBAL INITPPS
INITPPS:
...
;'RIGHT(SYSSTRINGTEMP) = SYSINSTRING(SYSCHARSTART + SYSSTRINGTEMP)
 ...
 ADDWF SYSCHARSTART,W,a
 MOVWF SYSTEMP2,a
 ADDWF SYSSYSINSTRINGHANDLER,W,a
 MOVWF FSR0,a
 MOVLW 0
 ADDWFC SYSSYSINSTRINGHANDLER_H,W,a
 MOVWF FSR0H,a
...
;'SOURCE: 150_SHOWING_TABLEEEPROM_DATA_TO_SERIAL_TERMINAL.GCB (116)
GLOBAL SHOWEEPROM
SHOWEEPROM:
;'HSERPRINTCRLF 2
 MOVLW 2
...
;'LEGACY METHOD
 SETF EEPROMADDRESS,a
 SETF EEPROMADDRESS_H,a
GLOBAL SYSFORLOOP1
SYSFORLOOP1:
 INCF EEPROMADDRESS,F,a
 BTFSC STATUS,2,a
 INCF EEPROMADDRESS_H,F,a
...
;'FOR EEPROMADDRESS = 0 TO CHIPEEPROM -1
 CLRF EEPROMADDRESS,a
 CLRF EEPROMADDRESS_H,a
GLOBAL SYSFORLOOP2
SYSFORLOOP2:
...
;'HSERPRINT RIGHT(HEX(EEPROMADDRESS_H),1)
 ...
 RCALL FN__HEXPICAS
 MOVLW LOW _HEXPICAS
 MOVWF SYSSYSINSTRINGHANDLER,a
 MOVLW HIGH _HEXPICAS
 MOVWF SYSSYSINSTRINGHANDLER_H,a
 MOVLW 1
 MOVWF SYSCHARCOUNT,a
 RCALL FN_RIGHT
 MOVLW LOW RIGHT
 MOVWF SYSPRINTDATAHANDLER,a
 MOVLW HIGH RIGHT
...
;'NEXT
;'POSITIVE VALUE STEP HANDLER IN FOR-NEXT STATEMENT :#4P 
 MOVF EEPROMADDRESS,W,a
 SUBLW 255
 MOVWF SYSTEMP1,a
 CLRF SYSTEMP2,a
 MOVF EEPROMADDRESS_H,W,a
 SUBWFB SYSTEMP2,W,a
 MOVWF SYSTEMP1_H,a
...
ORG 0X380020
GLOBAL DATATESTDATASOURCE
 DATATESTDATASOURCE:
  DB 0X01, 0X02, 0X03, 0X04, 0X05, 0X06
 ALIGN 2 ;X1
ORG 0X380026
GLOBAL DATATESTDATASOURCE2
 DATATESTDATASOURCE2:
