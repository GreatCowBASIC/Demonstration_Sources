...
;''
;'' The demo varies the PWM to the LED.  We are pretending the motor is connected to the port shown below, via a suitable motor control device.
;''
;''************************************************************************
;''@author  EvanV
;''@licence GPL
...
;SOURCE: 190_USING_AN_INTERRUPT_TO_MANAGE_THE_PWM_SIGNAL_TO_CONTROL_AN_LEDS_BRIGHTNESS.GCB (86)
...
;SOURCE: 190_USING_AN_INTERRUPT_TO_MANAGE_THE_PWM_SIGNAL_TO_CONTROL_AN_LEDS_BRIGHTNESS.GCB (100)
GLOBAL	PWMHANDLER
PWMHANDLER:
