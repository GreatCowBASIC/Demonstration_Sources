...
;HPWM_CCPTimerN 2, 40, ReadAD( AN0 ), 2    'DIFFERENT TIMER SUPPORTS DIFFERENT FREQUENCIES
	MOVLW	2
	MOVWF	PWMCHANNEL
	MOVLW	40
	MOVWF	PWMFREQ
	...
	CALL	HPWM_CCPTIMERN
;HPWM_CCPTimerN 1, 20, ReadAD( AN0 ), 4    'DIFFERENT TIMER SUPPORTS DIFFERENT FREQUENCIES
	MOVLW	1
	MOVWF	PWMCHANNEL
	MOVLW	20
	MOVWF	PWMFREQ
