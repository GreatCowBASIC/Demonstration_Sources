...
;   Source file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\243_use_pwmout_to_control_led_brightness.gcb
;   Setting file     : C:\GCstudio\gcbasic\use.ini
;   Preserve mode    : 2
;   Assembler        : GCASM
;   Programmer       : C:\GCstudio\PICKitPlus\PICKitCommandline.exe
;   Output file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\243_use_pwmout_to_control_led_brightness.build\243_use_pwmout_to_control_led_brightness.asm
;   Float Capability : 1
;********************************************************************************

;Set up the assembler options (Chip type, clock source, other bits and pieces)
 LIST p=18F46Q35, r=DEC
 TITLE       "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\243_use_pwmout_to_control_led_brightness.gcb"
 SUBTITLE    "08-17-2026 12:32:23"
...
DOPWM                            EQU    1284          ; 0x504 (SA)
PWMCHANNEL                       EQU    1287          ; 0x507 (SA)
PWMDUR                           EQU    1288          ; 0x508 (SA)
SOFTPWMCYCLES                    EQU    1289          ; 0x509 (SA)
SOFTPWMDUTY                      EQU    1290          ; 0x50A (SA)
...
;
;This demonstration flashes an LED to show the use of PWMOut() operations
;This will pulse the IO at a max 4~kHz
;
;************************************************************************
;@author  EvanV
;@licence GPL
...
;do
SysDoLoop_S1
;cycle parameter ( the third parameter ) is a purely arbitrary value as the loop will maintain a relatively constant PWM
;This will pulse the IO at a max 1.78~kHz
;PWMOut 1, 127, 4
	movlw	1
	movwf	PWMCHANNEL,ACCESS
	movlw	127
	movwf	SOFTPWMDUTY,ACCESS
	movlw	4
	movwf	SOFTPWMCYCLES,ACCESS
	banksel	0
	rcall	PWMOUT
;wait 3 ms
	movlw	3
...
;Legacy method
	clrf	PWMDUR,ACCESS
	movlw	1
	subwf	SOFTPWMCYCLES,W,ACCESS
	btfss	STATUS, C,ACCESS
	bra	SysForLoopEnd1
SysForLoop1
	incf	PWMDUR,F,ACCESS
;For DOPWM = 1 to 255
;Legacy method
	clrf	DOPWM,ACCESS
SysForLoop2
...
;if SoftPWMDuty > DOPWM then
	movf	SOFTPWMDUTY,W,ACCESS
	subwf	DOPWM,W,ACCESS
	btfsc	STATUS, C,ACCESS
	bra	ELSE2_1
;if PWMChannel = 1 then set PWM_Out1 ON
	decf	PWMCHANNEL,W,ACCESS
...
SysForLoopEnd2
;next PWMDur
	movf	SOFTPWMCYCLES,W,ACCESS
	subwf	PWMDUR,W,ACCESS
	btfss	STATUS, C,ACCESS
	bra	SysForLoop1
SysForLoopEnd1
	banksel	0
