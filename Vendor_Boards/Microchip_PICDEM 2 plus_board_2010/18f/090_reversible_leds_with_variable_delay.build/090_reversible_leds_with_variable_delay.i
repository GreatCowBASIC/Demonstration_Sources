# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Microchip_PICDEM 2 plus_board_2010\\18f\\090_reversible_leds_with_variable_delay.build\\090_reversible_leds_with_variable_delay.S"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Microchip_PICDEM 2 plus_board_2010\\18f\\090_reversible_leds_with_variable_delay.build\\090_reversible_leds_with_variable_delay.S" 2
...
# 90 "D:\\GreatCowBASICGits\\Demonstration_Sources.git\\Vendor_Boards\\Microchip_PICDEM 2 plus_board_2010\\18f\\090_reversible_leds_with_variable_delay.build\\090_reversible_leds_with_variable_delay.S" 2
...
GLOBAL DEBUGTRACK
 DEBUGTRACK EQU 1294 ; 0X50E (SA)
GLOBAL DELAYTEMP
 DELAYTEMP EQU 1280 ; 0X500 (SA)
GLOBAL DELAYTEMP2
 DELAYTEMP2 EQU 1281 ; 0X501 (SA)
GLOBAL LEDPORTSTATE
 LEDPORTSTATE EQU 1295 ; 0X50F (SA)
GLOBAL L_CALIBRATE
 L_CALIBRATE EQU 1296 ; 0X510 (SA) INT
GLOBAL L_CALIBRATE_H
 L_CALIBRATE_H EQU 1297 ; 0X511 (SA) INT
GLOBAL L_FROMHIGH
 L_FROMHIGH EQU 1298 ; 0X512 (SA) INT
GLOBAL L_FROMHIGH_H
 L_FROMHIGH_H EQU 1299 ; 0X513 (SA) INT
GLOBAL L_FROMLOW
 L_FROMLOW EQU 1300 ; 0X514 (SA) INT
GLOBAL L_FROMLOW_H
 L_FROMLOW_H EQU 1301 ; 0X515 (SA) INT
GLOBAL L_MAP
 L_MAP EQU 1302 ; 0X516 (SA)
GLOBAL L_MAP_H
 L_MAP_H EQU 1303 ; 0X517 (SA)
GLOBAL L_SYSCALC
 L_SYSCALC EQU 1304 ; 0X518 (SA) INT
GLOBAL L_SYSCALCF
...
GLOBAL L_SYSCALC_H
 L_SYSCALC_H EQU 1305 ; 0X519 (SA) INT
GLOBAL L_TOHIGH
 L_TOHIGH EQU 1310 ; 0X51E (SA) INT
GLOBAL L_TOHIGH_H
 L_TOHIGH_H EQU 1311 ; 0X51F (SA) INT
GLOBAL L_TOLOW
 L_TOLOW EQU 1312 ; 0X520 (SA) INT
GLOBAL L_TOLOW_H
 L_TOLOW_H EQU 1313 ; 0X521 (SA) INT
GLOBAL MYDELAY
 MYDELAY EQU 1314 ; 0X522 (SA)
GLOBAL MYDELAY_H
 MYDELAY_H EQU 1315 ; 0X523 (SA)
GLOBAL READAD
 READAD EQU 1316 ; 0X524 (SA) INT
GLOBAL SCALE
 SCALE EQU 1317 ; 0X525 (SA) INT
GLOBAL SCALE_H
 SCALE_H EQU 1318 ; 0X526 (SA) INT
GLOBAL SYSBITVAR0
 SYSBITVAR0 EQU 1319 ; 0X527 (SA)
GLOBAL SYSBYTETEMPX
...
;'LEDPORTSTATE = 1
 MOVLW 1
 MOVWF LEDPORTSTATE,a
;'DO
GLOBAL SYSDOLOOP_S1
SYSDOLOOP_S1:
;'DEBUG2
;'MACRO SOURCE: 090_REVERSIBLE_LEDS_WITH_VARIABLE_DELAY.GCB (250)
;'IF DEBUGTRACK.1 = 1 THEN GOTO $-1
 BTFSC DEBUGTRACK,1,a
;'IF DEBUGTRACK.1 = 1 THEN GOTO $-1
 GOTO $-1
;'IF DEBUGTRACK.1 = 1 THEN GOTO $-1
...
;'IF  FUNCKEYPRESSED() = TRUE THEN
 ...
 BTFSS SYSBITVAR0,2,a
 BRA ENDIF2
;'CHANGE THE DIRECTION
;'DIRECTION = NOT DIRECTION
 CLRF SYSTEMP1,a
 BTFSC SYSBITVAR0,0,a
 INCF SYSTEMP1,F,a
 COMF SYSTEMP1,F,a
 BCF SYSBITVAR0,0,a
 BTFSC SYSTEMP1,0,a
...
;'IF  DIRECTION = LED_LEFT  THEN
 BTFSS SYSBITVAR0,0,a
 BRA ELSE3_1
;'IF LEDPORTSTATE.3 = 1 THEN
 BTFSS LEDPORTSTATE,3,a
 BRA ELSE4_1
;'LEDPORTSTATE = 0
 CLRF LEDPORTSTATE,a
;'C = 1
...
;'ROTATE LEDPORTSTATE RIGHT
 RRCF LEDPORTSTATE,F,a
;'IF C = 1 THEN LEDPORTSTATE.3 = 1
 BTFSC STATUS,0,a
;'IF C = 1 THEN LEDPORTSTATE.3 = 1
 BSF LEDPORTSTATE,3,a
;'IF C = 1 THEN LEDPORTSTATE.3 = 1
;'END IF
GLOBAL ENDIF3
ENDIF3:
...
;'SOURCE: 090_REVERSIBLE_LEDS_WITH_VARIABLE_DELAY.GCB (211)
...
;'IF ( CURRENTSWITCHSTATE = TRUE ) AND ( LASTSWITCHSTATE = FALSE ) THEN
 CLRF SYSBYTETEMPX,a
 BTFSC SYSBITVAR0,3,a
 COMF SYSBYTETEMPX,F,a
 MOVFF SYSBYTETEMPX,SYSTEMP1
 CLRF SYSBYTETEMPX,a
 BTFSS SYSBITVAR0,1,a
 COMF SYSBYTETEMPX,F,a
...
;'LASTSWITCHSTATE = CURRENTSWITCHSTATE
 ...
 BSF SYSBITVAR0,1,a
;'DEBUG1
;'MACRO SOURCE: 090_REVERSIBLE_LEDS_WITH_VARIABLE_DELAY.GCB (246)
;'IF DEBUGTRACK.0 = 1 THEN GOTO $-1
 BTFSC DEBUGTRACK,0,a
;'IF DEBUGTRACK.0 = 1 THEN GOTO $-1
 GOTO $-1
;'IF DEBUGTRACK.0 = 1 THEN GOTO $-1
 BANKSEL 0
...
;'L_SYSCALC = (  L_FROMHIGH - L_FROMLOW )
 MOVF L_FROMLOW,W,a
 SUBWF L_FROMHIGH,W,a
 MOVWF L_SYSCALC,a
 MOVF L_FROMLOW_H,W,a
 SUBWFB L_FROMHIGH_H,W,a
 MOVWF L_SYSCALC_H,a
;'SCALE = (L_SYSCALCF / L_SYSCALC) + L_TOLOW + L_CALIBRATE
 ...
 MOVWF SYSTEMP2,a
 MOVF L_TOLOW_H,W,a
 ADDWFC SYSTEMP1_H,W,a
 MOVWF SYSTEMP2_H,a
 MOVF L_CALIBRATE,W,a
 ADDWF SYSTEMP2,W,a
 MOVWF SCALE,a
 MOVF L_CALIBRATE_H,W,a
 ADDWFC SYSTEMP2_H,W,a
 MOVWF SCALE_H,a
 RETURN
...
;'MOVF SYSLONGTEMPA_E,W
 MOVF SYSLONGTEMPA_E,W,a
;'SUBWF SYSLONGTEMPB_E,W
 SUBWF SYSLONGTEMPB_E,W,a
 ;BTFSS STATUS,0
 BTFSS STATUS,0,a
;'RETURN
 RETURN
...
;'MOVF SYSLONGTEMPA_U,W
 MOVF SYSLONGTEMPA_U,W,a
;'SUBWF SYSLONGTEMPB_U,W
 SUBWF SYSLONGTEMPB_U,W,a
 ;BTFSS STATUS,0
 BTFSS STATUS,0,a
;'RETURN
 RETURN
...
;'MOVF SYSLONGTEMPA_H,W
 MOVF SYSLONGTEMPA_H,W,a
;'SUBWF SYSLONGTEMPB_H,W
 SUBWF SYSLONGTEMPB_H,W,a
 ;BTFSS STATUS,0
 BTFSS STATUS,0,a
;'RETURN
 RETURN
...
;'SYSLONGDIVMULTX = 0
 CLRF SYSLONGDIVMULTX,a
 CLRF SYSLONGDIVMULTX_H,a
 CLRF SYSLONGDIVMULTX_U,a
 CLRF SYSLONGDIVMULTX_E,a
...
;'ROTATE SYSLONGDIVMULTA LEFT
 RLCF SYSLONGDIVMULTA,F,a
 RLCF SYSLONGDIVMULTA_H,F,a
 RLCF SYSLONGDIVMULTA_U,F,a
 RLCF SYSLONGDIVMULTA_E,F,a
;'ROTATE SYSLONGDIVMULTX LEFT
 RLCF SYSLONGDIVMULTX,F,a
 RLCF SYSLONGDIVMULTX_H,F,a
 RLCF SYSLONGDIVMULTX_U,F,a
 RLCF SYSLONGDIVMULTX_E,F,a
;'SYSLONGDIVMULTX = SYSLONGDIVMULTX - SYSLONGDIVMULTB
 MOVF SYSLONGDIVMULTB,W,a
 SUBWF SYSLONGDIVMULTX,F,a
 MOVF SYSLONGDIVMULTB_H,W,a
 SUBWFB SYSLONGDIVMULTX_H,F,a
 MOVF SYSLONGDIVMULTB_U,W,a
 SUBWFB SYSLONGDIVMULTX_U,F,a
 MOVF SYSLONGDIVMULTB_E,W,a
 SUBWFB SYSLONGDIVMULTX_E,F,a
;'SET SYSLONGDIVMULTA.0 ON
 BSF SYSLONGDIVMULTA,0,a
;'IF C OFF THEN
 BTFSC STATUS,0,a
 BRA ENDIF16
;'SET SYSLONGDIVMULTA.0 OFF
 BCF SYSLONGDIVMULTA,0,a
;'SYSLONGDIVMULTX = SYSLONGDIVMULTX + SYSLONGDIVMULTB
 MOVF SYSLONGDIVMULTB,W,a
 ADDWF SYSLONGDIVMULTX,F,a
 MOVF SYSLONGDIVMULTB_H,W,a
 ADDWFC SYSLONGDIVMULTX_H,F,a
 MOVF SYSLONGDIVMULTB_U,W,a
 ADDWFC SYSLONGDIVMULTX_U,F,a
 MOVF SYSLONGDIVMULTB_E,W,a
 ADDWFC SYSLONGDIVMULTX_E,F,a
;'END IF
GLOBAL ENDIF16
ENDIF16:
;'DECFSZ SYSDIVLOOP, F
...
;'IF SYSLONGDIVMULTB.0 ON THEN SYSLONGDIVMULTX += SYSLONGDIVMULTA
 BTFSS SYSLONGDIVMULTB,0,a
 BRA ENDIF13
;'IF SYSLONGDIVMULTB.0 ON THEN SYSLONGDIVMULTX += SYSLONGDIVMULTA
 MOVF SYSLONGDIVMULTA,W,a
 ADDWF SYSLONGDIVMULTX,F,a
 MOVF SYSLONGDIVMULTA_H,W,a
 ADDWFC SYSLONGDIVMULTX_H,F,a
 MOVF SYSLONGDIVMULTA_U,W,a
 ADDWFC SYSLONGDIVMULTX_U,F,a
 MOVF SYSLONGDIVMULTA_E,W,a
 ADDWFC SYSLONGDIVMULTX_E,F,a
;'IF SYSLONGDIVMULTB.0 ON THEN SYSLONGDIVMULTX += SYSLONGDIVMULTA
GLOBAL ENDIF13
ENDIF13:
...
;'ROTATE SYSLONGDIVMULTB RIGHT
 RRCF SYSLONGDIVMULTB_E,F,a
 RRCF SYSLONGDIVMULTB_U,F,a
 RRCF SYSLONGDIVMULTB_H,F,a
 RRCF SYSLONGDIVMULTB,F,a
;'SET STATUS.C OFF
 BCF STATUS,0,a
;'ROTATE SYSLONGDIVMULTA LEFT
 RLCF SYSLONGDIVMULTA,F,a
