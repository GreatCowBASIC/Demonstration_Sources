...
;   Source file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\040_rotate_the_leds.gcb
;   Setting file     : C:\GCstudio\gcbasic\use.ini
;   Preserve mode    : 2
;   Assembler        : GCASM
;   Programmer       : C:\GCstudio\gcbasic\..\PICKitPlus\PICKitCommandline.exe
;   Output file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\040_rotate_the_leds.build\040_rotate_the_leds.asm
;   Float Capability : 1
;********************************************************************************

;Set up the assembler options (Chip type, clock source, other bits and pieces)
 LIST p=18F46Q35, r=DEC
 TITLE       "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\040_rotate_the_leds.gcb"
 SUBTITLE    "08-07-2026 08:34:37"
...
LEDS                             EQU    1285          ; 0x505 (SA)
ROTATECOUNT                      EQU    1286          ; 0x506 (SA)
...
;LEDs = 0B0001  // Start with the first LED on
	movlw	1
	movwf	LEDS,ACCESS
;Another way to initialize a variable to hold the LED states
;! DIM LEDs AS BYTE = 0B0001
...
;End If
ENDIF1
;WAIT 1 s  // Wait 100 milliseconds
	movlw	1
