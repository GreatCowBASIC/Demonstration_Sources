...
;   Source file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\205_i2c_glcd_using_ssd1309_128_64.gcb
;   Setting file     : C:\GCstudio\gcbasic\use.ini
;   Preserve mode    : 2
;   Assembler        : GCASM
;   Programmer       : C:\GCstudio\PICKitPlus\PICKitCommandline.exe
;   Output file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\205_i2c_glcd_using_ssd1309_128_64.build\205_i2c_glcd_using_ssd1309_128_64.asm
;   Float Capability : 1
;********************************************************************************

;Set up the assembler options (Chip type, clock source, other bits and pieces)
 LIST p=18F46Q35, r=DEC
 TITLE       "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\205_i2c_glcd_using_ssd1309_128_64.gcb"
 SUBTITLE    "08-15-2026 07:51:25"
...
FILLED_ELLIPSE                   EQU    1316          ; 0x524 (SA)
GLCDBACKGROUND                   EQU    1317          ; 0x525 (SA)
GLCDBACKGROUND_H                 EQU    1318          ; 0x526 (SA)
GLCDBITNO                        EQU    1319          ; 0x527 (SA)
GLCDCHANGE                       EQU    1320          ; 0x528 (SA)
GLCDCOLOUR                       EQU    1321          ; 0x529 (SA)
GLCDCOLOUR_H                     EQU    1322          ; 0x52A (SA)
GLCDDATATEMP                     EQU    1323          ; 0x52B (SA)
GLCDFNTDEFAULT                   EQU    1324          ; 0x52C (SA)
GLCDFNTDEFAULTHEIGHT             EQU    1325          ; 0x52D (SA)
GLCDFNTDEFAULTSIZE               EQU    1326          ; 0x52E (SA)
GLCDFONTWIDTH                    EQU    1327          ; 0x52F (SA)
GLCDFOREGROUND                   EQU    1328          ; 0x530 (SA)
GLCDFOREGROUND_H                 EQU    1329          ; 0x531 (SA)
GLCDPRINTLEN                     EQU    1330          ; 0x532 (SA)
GLCDPRINTLOC                     EQU    1331          ; 0x533 (SA)
GLCDPRINTLOC_H                   EQU    1332          ; 0x534 (SA)
GLCDPRINT_STRING_COUNTER         EQU    1333          ; 0x535 (SA)
GLCDTEMP                         EQU    1334          ; 0x536 (SA)
GLCDTEMP_H                       EQU    1335          ; 0x537 (SA)
GLCDX                            EQU    1336          ; 0x538 (SA)
GLCDY                            EQU    1337          ; 0x539 (SA)
GLCD_EX2                         EQU    1338          ; 0x53A (SA)
GLCD_EX2_E                       EQU    1341          ; 0x53D (SA)
GLCD_EX2_H                       EQU    1339          ; 0x53B (SA)
GLCD_EX2_U                       EQU    1340          ; 0x53C (SA)
GLCD_EY2                         EQU    1342          ; 0x53E (SA)
GLCD_EY2_E                       EQU    1345          ; 0x541 (SA)
GLCD_EY2_H                       EQU    1343          ; 0x53F (SA)
GLCD_EY2_U                       EQU    1344          ; 0x540 (SA)
GLCD_FX2                         EQU    1346          ; 0x542 (SA)
GLCD_FX2_E                       EQU    1349          ; 0x545 (SA)
GLCD_FX2_H                       EQU    1347          ; 0x543 (SA)
GLCD_FX2_U                       EQU    1348          ; 0x544 (SA)
GLCD_FY2                         EQU    1350          ; 0x546 (SA)
GLCD_FY2_E                       EQU    1353          ; 0x549 (SA)
GLCD_FY2_H                       EQU    1351          ; 0x547 (SA)
GLCD_FY2_U                       EQU    1352          ; 0x548 (SA)
GLCD_PP                          EQU    1354          ; 0x54A (SA)
GLCD_PP_E                        EQU    1357          ; 0x54D (SA)
GLCD_PP_H                        EQU    1355          ; 0x54B (SA)
GLCD_PP_TEMP                     EQU    1358          ; 0x54E (SA)
GLCD_PP_TEMP_E                   EQU    1361          ; 0x551 (SA)
GLCD_PP_TEMP_H                   EQU    1359          ; 0x54F (SA)
GLCD_PP_TEMP_U                   EQU    1360          ; 0x550 (SA)
GLCD_PP_U                        EQU    1356          ; 0x54C (SA)
GLCD_PX                          EQU    1362          ; 0x552 (SA)
GLCD_PX_E                        EQU    1365          ; 0x555 (SA)
GLCD_PX_H                        EQU    1363          ; 0x553 (SA)
GLCD_PX_U                        EQU    1364          ; 0x554 (SA)
GLCD_PY                          EQU    1366          ; 0x556 (SA)
GLCD_PY_E                        EQU    1369          ; 0x559 (SA)
GLCD_PY_H                        EQU    1367          ; 0x557 (SA)
GLCD_PY_U                        EQU    1368          ; 0x558 (SA)
GLCD_RX2                         EQU    1370          ; 0x55A (SA)
GLCD_RX2_H                       EQU    1371          ; 0x55B (SA)
GLCD_RY2                         EQU    1372          ; 0x55C (SA)
GLCD_RY2_H                       EQU    1373          ; 0x55D (SA)
GLCD_XX                          EQU    1374          ; 0x55E (SA)
GLCD_XX_H                        EQU    1375          ; 0x55F (SA)
...
ROW                              EQU    1441          ; 0x5A1
SSD1309SENDBYTE                  EQU    1442          ; 0x5A2
SSD1309_BUFFERALIAS              EQU    4351          ; 0x10FF
SSD1309_BUFFERLOCATIONCALC       EQU    1443          ; 0x5A3
SSD1309_BUFFERLOCATIONCALC_H     EQU    1444          ; 0x5A4
STR                              EQU    4178          ; 0x1052
...
;Write_Command_SSD1309( PosCharX )
	movff	POSCHARX,SSD1309SENDBYTE
	banksel	0
	call	WRITE_COMMAND_SSD1309
;PosCharX = LocX
	movff	LOCX,POSCHARX
...
;Write_Command_SSD1309 ( PosCharX )
	movff	POSCHARX,SSD1309SENDBYTE
	banksel	0
	goto	WRITE_COMMAND_SSD1309

;********************************************************************************

;Overloaded signature: WORD:WORD:WORD:WORD:word:, Source: glcd.h (4177)
...
;Overloaded signature: WORD:WORD:WORD:WORD:word:, Source: glcd.h (4129)
ELLIPSE37
;Version 1.00 (08/20/2017) by Joseph Realmuto
...
;Overloaded signature: WORD:WORD:WORD:WORD:word:, Source: glcd.h (4153)
FILLEDELLIPSE39
;Version 1.00 (08/20/2017) by Joseph Realmuto
...
;Legacy method
	clrf	SSD1309_BUFFERLOCATIONCALC,BANKED
	clrf	SSD1309_BUFFERLOCATIONCALC_H,BANKED
SysForLoop11
	banksel	SSD1309_BUFFERLOCATIONCALC
	incf	SSD1309_BUFFERLOCATIONCALC,F,BANKED
	btfsc	STATUS,Z,ACCESS
	incf	SSD1309_BUFFERLOCATIONCALC_H,F,BANKED
;SSD1309_BufferAlias(SSD1309_BufferLocationCalc) = 0
	lfsr	0,SSD1309_BUFFERALIAS
	movf	SSD1309_BUFFERLOCATIONCALC,W,BANKED
	addwf	AFSR0,F,ACCESS
	movf	SSD1309_BUFFERLOCATIONCALC_H,W,BANKED
	addwfc	AFSR0_H,F,ACCESS
	clrf	INDF0,ACCESS
;Next
	movff	SSD1309_BUFFERLOCATIONCALC,SysWORDTempA
	movff	SSD1309_BUFFERLOCATIONCALC_H,SysWORDTempA_H
...
;Cursor_Position_SSD1309 ( 0 , SSD1309_BufferLocationCalc )
	clrf	LOCX,BANKED
	movff	SSD1309_BUFFERLOCATIONCALC,LOCY
	banksel	0
	call	CURSOR_POSITION_SSD1309
;Open_Transaction_SSD1309
;Macro Source: GLCD_SSD1309.H (1273)
...
;Macro Source: GLCD_SSD1309.H (1304)
...
;Macro Source: GLCD_SSD1309.H (1337)
;4wire not supported, see Write_Transaction_Data_SSD1309
;HI2CStop
...
;IF ( SSD1309_BUFFERLOCATIONCALC - 64-1) } [WORD]SysForLoopABsValue12 THEN  :#1n 
	movlw	64
	subwf	SSD1309_BUFFERLOCATIONCALC,W,BANKED
	movwf	SysTemp2,BANKED
	movlw	0
	subwfb	SSD1309_BUFFERLOCATIONCALC_H,W,BANKED
...
;Set LoopVar to LoopVar + StepValue where StepValue is a negative value
	...
	addwf	SSD1309_BUFFERLOCATIONCALC,F,BANKED
	movf	SysForLoopStep11_H,W,BANKED
	addwfc	SSD1309_BUFFERLOCATIONCALC_H,F,BANKED
	bra	SysForLoop12
;END IF
ENDIF61
	bra	ENDIF60
...
;IF ([WORD]64-1 - [WORD]SSD1309_BUFFERLOCATIONCALC) } [WORD]SysForLoopStep11 THEN :#1p 
	movf	SSD1309_BUFFERLOCATIONCALC,W,BANKED
	sublw	63
	movwf	SysTemp2,BANKED
...
;Source: 205_i2c_glcd_using_ssd1309_128_64.gcb (75)
INITPPS
...
;SSD1309_BufferLocationCalc = GLCDY
	movff	GLCDY,SSD1309_BUFFERLOCATIONCALC
	clrf	SSD1309_BUFFERLOCATIONCALC_H,BANKED
;Repeat 3
	movlw	3
...
;Rotate SSD1309_BufferLocationCalc Right
	rrcf	SSD1309_BUFFERLOCATIONCALC_H,F,BANKED
	rrcf	SSD1309_BUFFERLOCATIONCALC,F,BANKED
;End Repeat
...
;Rotate SSD1309_BufferLocationCalc Left
	rlcf	SSD1309_BUFFERLOCATIONCALC,F,BANKED
	rlcf	SSD1309_BUFFERLOCATIONCALC_H,F,BANKED
;End Repeat
	decfsz	SysRepeatTemp1,F,BANKED
	bra	SysRepeatLoop2
SysRepeatLoopEnd2
;SSD1309_BufferLocationCalc = GLCDX + SSD1309_BufferLocationCalc + 1
	...
	movlw	1
	addwf	SysTemp2,W,BANKED
	movwf	SSD1309_BUFFERLOCATIONCALC,BANKED
	movlw	0
	addwfc	SysTemp2_H,W,BANKED
	movwf	SSD1309_BUFFERLOCATIONCALC_H,BANKED
...
;if SSD1309_BufferLocationCalc > GLCD_HEIGHT * GLCD_WIDTH Then
	movff	SSD1309_BUFFERLOCATIONCALC,SysWORDTempB
	movff	SSD1309_BUFFERLOCATIONCALC_H,SysWORDTempB_H
	clrf	SysWORDTempA,ACCESS
	movlw	32
...
;Write_Data_SSD1309 ( GLCDDataTemp )
	movff	GLCDDATATEMP,SSD1309SENDBYTE
...
StringTable2
	db	12,65,110,111,98,105,117,109,32,50,48,50,54
