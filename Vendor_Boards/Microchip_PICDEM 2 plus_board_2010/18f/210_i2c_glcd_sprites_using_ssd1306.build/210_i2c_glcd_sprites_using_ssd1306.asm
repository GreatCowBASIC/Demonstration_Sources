...
;   Source file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\210_i2c_glcd_sprites_using_ssd1306.gcb
;   Setting file     : C:\GCstudio\gcbasic\use.ini
;   Preserve mode    : 2
;   Assembler        : GCASM
;   Programmer       : C:\GCstudio\PICKitPlus\PICKitCommandline.exe
;   Output file      : D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\210_i2c_glcd_sprites_using_ssd1306.build\210_i2c_glcd_sprites_using_ssd1306.asm
;   Float Capability : 1
;********************************************************************************

;Set up the assembler options (Chip type, clock source, other bits and pieces)
 LIST p=18F46Q35, r=DEC
 TITLE       "D:\GreatCowBASICGits\Demonstration_Sources.git\Vendor_Boards\Microchip_PICDEM 2 plus_board_2010\18f\210_i2c_glcd_sprites_using_ssd1306.gcb"
 SUBTITLE    "08-15-2026 08:39:34"
...
CHARCODE                         EQU    1291          ; 0x50B (SA)
CHARCOL                          EQU    1292          ; 0x50C (SA)
CHARCOLS                         EQU    1294          ; 0x50E (SA)
CHARCOL_H                        EQU    1293          ; 0x50D (SA)
CHARLOCX                         EQU    1295          ; 0x50F (SA)
CHARLOCX_H                       EQU    1296          ; 0x510 (SA)
CHARLOCY                         EQU    1297          ; 0x511 (SA)
CHARLOCY_H                       EQU    1298          ; 0x512 (SA)
CHARROW                          EQU    1299          ; 0x513 (SA)
CHARROWS                         EQU    1301          ; 0x515 (SA)
CHARROW_H                        EQU    1300          ; 0x514 (SA)
COL                              EQU    1302          ; 0x516 (SA)
CURRCHARCOL                      EQU    1303          ; 0x517 (SA)
CURRCHARROW                      EQU    1304          ; 0x518 (SA)
CURRCHARVAL                      EQU    1305          ; 0x519 (SA)
CURX                             EQU    1306          ; 0x51A (SA)
CURY                             EQU    1307          ; 0x51B (SA)
DELAYTEMP                        EQU    1280          ; 0x500 (SA)
DELAYTEMP2                       EQU    1281          ; 0x501 (SA)
DIRX                             EQU    1308          ; 0x51C (SA)
DIRY                             EQU    1309          ; 0x51D (SA)
DRAWLINE                         EQU    1310          ; 0x51E (SA)
DRAWLINE_H                       EQU    1311          ; 0x51F (SA)
GLCDBACKGROUND                   EQU    1312          ; 0x520 (SA)
GLCDBACKGROUND_H                 EQU    1313          ; 0x521 (SA)
GLCDBITNO                        EQU    1314          ; 0x522 (SA)
GLCDCHANGE                       EQU    1315          ; 0x523 (SA)
GLCDCOLOUR                       EQU    1316          ; 0x524 (SA)
GLCDCOLOUR_H                     EQU    1317          ; 0x525 (SA)
GLCDDATATEMP                     EQU    1318          ; 0x526 (SA)
GLCDFNTDEFAULT                   EQU    1319          ; 0x527 (SA)
GLCDFNTDEFAULTHEIGHT             EQU    1320          ; 0x528 (SA)
GLCDFNTDEFAULTSIZE               EQU    1321          ; 0x529 (SA)
GLCDFONTWIDTH                    EQU    1322          ; 0x52A (SA)
GLCDFOREGROUND                   EQU    1323          ; 0x52B (SA)
GLCDFOREGROUND_H                 EQU    1324          ; 0x52C (SA)
GLCDHICHANGE                     EQU    1325          ; 0x52D (SA)
GLCDLOCHANGE                     EQU    1326          ; 0x52E (SA)
GLCDPRINTLEN                     EQU    1327          ; 0x52F (SA)
GLCDPRINTLOC                     EQU    1328          ; 0x530 (SA)
GLCDPRINTLOC_H                   EQU    1329          ; 0x531 (SA)
GLCDPRINT_STRING_COUNTER         EQU    1330          ; 0x532 (SA)
GLCDROTATEBITS                   EQU    1331          ; 0x533 (SA)
GLCDTEMP                         EQU    1332          ; 0x534 (SA)
GLCDTEMP_H                       EQU    1333          ; 0x535 (SA)
GLCDX                            EQU    1334          ; 0x536 (SA)
GLCDY                            EQU    1335          ; 0x537 (SA)
GLCD_YORDINATE                   EQU    1336          ; 0x538 (SA)
GLCD_YORDINATE_H                 EQU    1337          ; 0x539 (SA)
HI2C1LASTERROR                   EQU    1338          ; 0x53A (SA)
HI2C1STATEMACHINE                EQU    1339          ; 0x53B (SA)
HI2CACKPOLLSTATE                 EQU    1340          ; 0x53C (SA)
HI2CCURRENTMODE                  EQU    1341          ; 0x53D (SA)
HI2CWAITMSSPTIMEOUT              EQU    1342          ; 0x53E (SA)
HWI2C_BUFFER                     EQU    4316          ; 0x10DC
HWI2C_BUFFERLOCATIONCOUNTER      EQU    1343          ; 0x53F (SA)
HWI2C_BUFFERLOCATIONCOUNTERINDEX EQU    1345          ; 0x541 (SA)
HWI2C_BUFFERLOCATIONCOUNTERINDEX EQU    1346          ; 0x542 (SA)
HWI2C_BUFFERLOCATIONCOUNTER_H    EQU    1344          ; 0x540 (SA)
I2CBYTE                          EQU    1347          ; 0x543 (SA)
LINECOLOUR                       EQU    1348          ; 0x544 (SA)
LINECOLOUR_H                     EQU    1349          ; 0x545 (SA)
LINEX1                           EQU    1350          ; 0x546 (SA)
LINEX1_H                         EQU    1351          ; 0x547 (SA)
LINEX2                           EQU    1352          ; 0x548 (SA)
LINEX2_H                         EQU    1353          ; 0x549 (SA)
LINEY1                           EQU    1354          ; 0x54A (SA)
LINEY1_H                         EQU    1355          ; 0x54B (SA)
LINEY2                           EQU    1356          ; 0x54C (SA)
LINEY2_H                         EQU    1357          ; 0x54D (SA)
LOCX                             EQU    1358          ; 0x54E (SA)
LOCY                             EQU    1359          ; 0x54F (SA)
OLDX                             EQU    1360          ; 0x550 (SA)
OLDY                             EQU    1361          ; 0x551 (SA)
POSCHARX                         EQU    1362          ; 0x552 (SA)
POSCHARX_H                       EQU    1363          ; 0x553 (SA)
POSCHARY                         EQU    1364          ; 0x554 (SA)
PRINTLOCX                        EQU    1365          ; 0x555 (SA)
PRINTLOCX_H                      EQU    1366          ; 0x556 (SA)
PRINTLOCY                        EQU    1367          ; 0x557 (SA)
PRINTLOCY_H                      EQU    1368          ; 0x558 (SA)
RANDOM                           EQU    1369          ; 0x559 (SA)
RANDOMSEED                       EQU    1370          ; 0x55A (SA)
RANDOMSEED_H                     EQU    1371          ; 0x55B (SA)
RANDOMTEMP                       EQU    1372          ; 0x55C (SA)
RANDOMTEMP_H                     EQU    1373          ; 0x55D (SA)
ROW                              EQU    1374          ; 0x55E (SA)
SSD1306SENDBYTE                  EQU    1375          ; 0x55F (SA)
...
;Using SYSSTRINGPARAM1*7
	banksel	0
	call	GLCDPRINT7
;GLCDPrint ( 2, 46, "GLCD Library 2026")
	movlw	2
	movwf	PRINTLOCX,ACCESS
	clrf	PRINTLOCX_H,ACCESS
	movlw	46
...
;Source: 210_i2c_glcd_sprites_using_ssd1306.gcb (257)
...
;Macro Source: 210_i2c_glcd_sprites_using_ssd1306.gcb (486)
;Dim I2CByte As Byte
;HI2CStart
	call	SI2CSTART
;HI2CSend GLCD_I2C_Address
...
;Source: 210_i2c_glcd_sprites_using_ssd1306.gcb (59)
INITPPS
...
StringTable2
	db	17,71,76,67,68,32,76,105,98,114,97,114,121,32,50,48,50,54
